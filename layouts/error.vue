  ...
  <v-container fill-height>
    <v-row>
      <v-col cols="12" sm="6">
        ...
        <p class="text-h6 headline">Sorry, page not found.</p>
        <p class="mb-8">
          Don´t worry, click on the button to return to main page.
        </p>

        <v-btn outlined depressed color="primary" nuxt to="/"> Home </v-btn>
      </v-col>
      <v-col cols="12" sm="6">
        <div>
          <svg
