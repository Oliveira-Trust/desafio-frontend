...
const Action = <T extends GenericObject>({ icon, tooltip, callback, data }: IProps<T>) => {

    return (
        <div>
            <div className='group relative inline-block'>
                <button onClick={() => callback(data)} className='rounded-full w-7 h-7 trasition delay-100  hover:bg-zinc-200'>
