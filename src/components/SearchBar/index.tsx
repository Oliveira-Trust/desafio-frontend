    ...
    return (
        <div className='bg-white shadow-md rounded px-8 pt-6 pb-6'>
            <form className='flex justify-between gap-2' onSubmit={handleSubmit(onSubmit)} >
                <InnerLabelInput register={register} id='nome_search' label='Nome' placeholder='Nome' />
                <InnerLabelInput register={register} id='sobrenome_search' label='Sobrenome' placeholder='Sobrenome' />
                <InnerLabelInput register={register} id='email_search' label='E-mail' placeholder='E-mail' />
